...
old="'case \"prismatic_wall\" -> 400','case \"control_weather\" -> 600']:"
new="'case \"prismatic_wall\" -> 400','case \"control_weather\" -> 900']:"
if old not in s: raise SystemExit('visual weather duration missing')
s=s.replace(old,new,1)
...
if 'alpha47_visible_footprint_destruction=PASS' not in s: s+=append
