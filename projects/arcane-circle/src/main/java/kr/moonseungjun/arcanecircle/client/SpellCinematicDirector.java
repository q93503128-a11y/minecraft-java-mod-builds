...
final class SpellCinematicDirector {
    ...
    private static void prismaticWallFrame(ArcaneWorldMesh.Builder m,ArcaneWorldMesh.Basis b,Vec3 target,double range,double age,int circle){
    ...
    private static void meteorShardImpact(ArcaneWorldMesh.Builder m,Vec3 target,double age,double impact,double scale){
    ...
    private static Signature signature(SpellDefinition s){
        ...
        return switch(id){
            ...
            case "flame_strike","fire_storm","meteor_swarm","delayed_blast_fireball","meteor_shard" -> sig(Form.SKY,
