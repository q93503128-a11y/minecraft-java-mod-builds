...
public final class FishingEntities {
    public static final EntityType<EncounterFishEntity> SMALL_FISH =
            register("encounter_small_fish", 0.55f, 0.35f);
    public static final EntityType<EncounterFishEntity> FAT_FISH =
            register("encounter_fat_fish", 0.85f, 0.58f);
    public static final EntityType<EncounterFishEntity> LONG_FISH =
            register("encounter_long_fish", 1.15f, 0.48f);
    ...
    private static EntityType<EncounterFishEntity> register(String path, float width, float height) {
        ...
        EntityType<EncounterFishEntity> type = EntityType.Builder
                .of(EncounterFishEntity::new, MobCategory.MISC)
                .sized(width, height)
