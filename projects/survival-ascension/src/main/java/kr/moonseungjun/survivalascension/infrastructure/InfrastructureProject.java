...
public enum InfrastructureProject {
    QUARRY_NETWORK(
            "quarry_network", "채석장 네트워크", "채굴 Lv.90 터널 굴착 5×5×8", 0,
            List.of(
    ...
    BUILDER_FOUNDRY(
            "builder_foundry", "건축 공방", "건축 Lv.90 입체 채우기 5×5×5", 0,
            List.of(
    ...
    COMBAT_ACADEMY(
            "combat_academy", "전투 훈련장", "전투 Lv.90 질주 충격파 · 반경 5.5블록 최대 12체", 0,
            List.of(
    ...
    ASCENSION_NEXUS(
            "ascension_nexus", "승천 중추", "종말 단계 · 기동 Lv.90 공중 돌진 2회", 2,
            List.of(
