...
public final class SkillsScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        String subtitle = "M 메뉴에서 열기 · Shift = 광역 작업 정밀 모드";
    ...
    private static boolean isActive(SkillType skill) {
        return skill != SkillType.MOBILITY;
    }
    ...
    private static String detail(SkillType skill, int level) {
        return switch (skill) {
            ...
            case CONSTRUCTION -> "선 " + SkillTuning.constructionLineLength(level) + "블록 · 면 "
                    + SkillTuning.constructionPlaneSize(level) + "×" + SkillTuning.constructionPlaneSize(level);
