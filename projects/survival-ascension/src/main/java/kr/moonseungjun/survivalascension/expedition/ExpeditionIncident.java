...
public enum ExpeditionIncident {
    ...
    WOODLAND_FRONTIER_RUSH(ExpeditionRegion.WOODLAND, "고목길 개척", 900, ExpeditionAction.LOGS_FELLED, 32),
    ...
    ARID_FRONTIER_AMBUSH(ExpeditionRegion.ARID, "사막 협곡 포위", 1200, 6,
            "minecraft:husk", "minecraft:pillager", "minecraft:spider"),
    ...
    WETLAND_FRONTIER_RUSH(ExpeditionRegion.WETLAND, "침수지 긴급 수확", 900, ExpeditionAction.CROPS_HARVESTED, 28),
    ...
    HIGHLANDS_FRONTIER_AMBUSH(ExpeditionRegion.HIGHLANDS, "절벽 사냥대", 1200, 6,
    ...
    /**
     * Data-integrated terrain receives two additional regional incidents instead of merely sharing
    ...
    public static List<ExpeditionIncident> forRegion(ExpeditionRegion region, boolean integrationTagged) {
        ...
        return switch (region) {
            case WOODLAND -> List.of(WOODLAND_AMBUSH, WOODLAND_RUSH, WOODLAND_FRONTIER_AMBUSH, WOODLAND_FRONTIER_RUSH);
            case ARID -> List.of(ARID_AMBUSH, ARID_RUSH, ARID_FRONTIER_RUSH, ARID_FRONTIER_AMBUSH);
            case WETLAND -> List.of(WETLAND_AMBUSH, WETLAND_RUSH, WETLAND_FRONTIER_AMBUSH, WETLAND_FRONTIER_RUSH);
            case HIGHLANDS -> List.of(HIGHLANDS_AMBUSH, HIGHLANDS_RUSH, HIGHLANDS_FRONTIER_RUSH, HIGHLANDS_FRONTIER_AMBUSH);
            case OCEAN -> List.of(OCEAN_AMBUSH, OCEAN_RUSH, OCEAN_FRONTIER_AMBUSH, OCEAN_FRONTIER_RUSH);
            case DEEP -> List.of(DEEP_AMBUSH, DEEP_RUSH, DEEP_FRONTIER_AMBUSH, DEEP_FRONTIER_RUSH);
            case FROZEN -> List.of(FROZEN_AMBUSH, FROZEN_RUSH, FROZEN_FRONTIER_RUSH, FROZEN_FRONTIER_AMBUSH);
            case NETHER -> List.of(NETHER_AMBUSH, NETHER_RUSH, NETHER_FRONTIER_AMBUSH, NETHER_FRONTIER_RUSH);
            case END -> List.of(END_AMBUSH, END_RUSH, END_FRONTIER_RUSH, END_FRONTIER_AMBUSH);
        };
    }
