...
public final class ProductionRadialMenuScreen extends Screen {
    private static final Entry[] ENTRIES = {
            ...
            new Entry("제련 배치", "반복 생산 · 철 원석 16 · 구리 원석 16 · 석탄 12", new ItemStack(Items.BLAST_FURNACE), "metalworks", Action.PRODUCE),
            new Entry("구조재 배치", "반복 생산 · 아무 종류의 통나무 32 · 조약돌 64 · 철 주괴 6", new ItemStack(Items.IRON_AXE), "timberworks", Action.PRODUCE),
            new Entry("식량 배치", "반복 생산 · 밀 24 · 당근 12 · 감자 12 · 비트 6", new ItemStack(Items.HAY_BLOCK), "provisions", Action.PRODUCE),
            new Entry("정밀 부품 배치", "반복 생산 · 레드스톤 24 · 자수정 조각 12 · 금 주괴 6 · 네더 석영 12", new ItemStack(Items.COMPARATOR), "precision", Action.PRODUCE),
            new Entry("물류 거점 연결", "산업 가공소 완공 → 통/공용 보급고 4블록 이내 → 원격 물류 등록 · 보급권 1 · 다시 선택하면 해제", new ItemStack(Items.BARREL), "", Action.DEPOT),
            new Entry("창고 통 연결", "통/공용 보급고 4블록 이내에서 선택 · 자신의 거점 6블록 안에 연결 · 거점당 최대 8 · 추가 보급권 없음", new ItemStack(Items.CHEST), "", Action.WAREHOUSE),
            new Entry("현장 일괄 적재", "주 인벤토리 대량 자원 → 같은 차원에서 로딩된 등록 물류 통 · 핫바/장비 유지", new ItemStack(Items.HOPPER), "", Action.OFFLOAD),
            new Entry("물리 화물 수레", "일반=대량 · Shift=전선묶음(원정/방어/요새 각1) · 레일6+·동력레일·호퍼·제어", new ItemStack(Items.CHEST_MINECART), "", Action.FREIGHT),
            new Entry("전초기지 승격", "등록 통+침대+모닥불+작업대+화로 · 보급권 2 · 철 주괴 32 · 금 주괴 8 · 석탄 32", new ItemStack(Items.CAMPFIRE), "", Action.OUTPOST),
            new Entry("전초 방어전", "보급권 1 + 전초 재고(식량 16 · 철 주괴 5 · 아무 종류의 통나무 12) · 3공세", new ItemStack(Items.SHIELD), "", Action.SIEGE),
            new Entry("요새 방어전", "보급권 2 + 전초 재고(식량 32 · 철 주괴 8 · 석재 벽돌 32) · 벽+4공세", new ItemStack(Items.STONE_BRICK_WALL), "", Action.BASTION),
            new Entry("원정 작전", "보급권 1 + 전초 재고(식량 12 · 철 주괴 3 · 연료: 석탄 또는 숯 3) · 전진→작업→귀환", new ItemStack(Items.SPYGLASS), "", Action.OPERATION),
            new Entry("현장 복귀 계약", "활성 전초기지에서 보급권1 · 일반 사망 96블록 내 1회 복귀", new ItemStack(Items.COMPASS), "", Action.RECOVERY),
            new Entry("현장 보급 출고", "보급권 1 → 금 주괴 32 · 자수정 조각 16 · 메아리 조각 2", new ItemStack(Items.MINECART), "", Action.DISPATCH),
    ...
    @Override public void extractRenderState(GuiGraphicsExtractor graphics,int mouseX,int mouseY,float partialTick){
        ...
        Entry entry=ENTRIES[selected];graphics.text(this.font,entry.title(),cx-this.font.width(entry.title())/2,cy-10,0xFFFFFFFF,true);renderDetailLines(graphics,entry.detail(),cx,cy+3);
