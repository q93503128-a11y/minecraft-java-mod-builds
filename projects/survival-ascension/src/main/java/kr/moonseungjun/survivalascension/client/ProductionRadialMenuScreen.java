...
public final class ProductionRadialMenuScreen extends Screen {
    private static final Entry[] ENTRIES = {
            ...
            new Entry("물류 거점 연결", "산업 가공소 완공 → 통 4블록 이내 → 선택 · 등록 보급권 1 · 다시 선택하면 해제", new ItemStack(Items.BARREL), "", Action.DEPOT),
            new Entry("창고 통 연결", "통 4블록 이내에서 선택 · 자신의 거점 6블록 안에 연결 · 거점당 최대 8 · 추가 보급권 없음", new ItemStack(Items.CHEST), "", Action.WAREHOUSE),
