...
public final class SurvivalAscension {
    ...
    public static final String VERSION = "0.48.0-alpha.1";
    // 0.48: frontline operations now require real local outpost stock, giving physical freight a direct combat/expedition purpose.
    ...
    public SurvivalAscension(IEventBus modEventBus) {
        ...
        LOGGER.info("Survival Ascension {} loaded: scaled mastery + frontline local supply + tagged major targets + shovel earthworks + optional expedition biome tags + content-pack gear imprint + physical logistics/freight + civil works + destructible bastion defense", VERSION);
    }
}
