...
public final class SurvivalAscension {
    ...
    public static final String VERSION = "0.20.0-alpha.1";
    ...
    public SurvivalAscension(IEventBus modEventBus) {
        ...
        LOGGER.info("Survival Ascension {} loaded: six skills + mastery VI + tactical warbands + world ascension + endgame mutations", VERSION);
    }
}
