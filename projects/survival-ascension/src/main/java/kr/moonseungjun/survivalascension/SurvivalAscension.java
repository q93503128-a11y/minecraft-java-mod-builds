...
public final class SurvivalAscension {
    ...
    public static final String VERSION = "0.35.0-alpha.1";
    // 0.35 final contract: bulk gathered materials can be explicitly offloaded into the same nearby physical logistics stock used by 0.34 sinks.
    ...
    public SurvivalAscension(IEventBus modEventBus) {
        ...
        LOGGER.info("Survival Ascension {} loaded: scaled mastery + physical logistics intake/output + sortie complications", VERSION);
    }
}
