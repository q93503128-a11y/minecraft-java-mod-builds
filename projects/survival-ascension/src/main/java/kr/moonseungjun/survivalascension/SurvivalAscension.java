...
public final class SurvivalAscension {
    ...
    public static final String VERSION = "0.34.0-alpha.1";
    // 0.34 final contract: large base-side sinks consume player inventory first, then only nearby usable owned Barrel logistics.
    ...
    public SurvivalAscension(IEventBus modEventBus) {
        ...
        LOGGER.info("Survival Ascension {} loaded: scaled mastery + integrated physical logistics + sortie complications", VERSION);
    }
}
