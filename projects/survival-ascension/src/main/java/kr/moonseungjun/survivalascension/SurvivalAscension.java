...
public final class SurvivalAscension {
    ...
    public static final String VERSION = "0.18.0-alpha.1";
    ...
    public SurvivalAscension(IEventBus modEventBus) {
        ...
        LOGGER.info("Survival Ascension {} loaded: six skills + tactical warbands + boss-driven world ascension + Ascension Nexus", VERSION);
    }
}
