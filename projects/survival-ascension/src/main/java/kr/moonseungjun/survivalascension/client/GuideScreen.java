...
public final class GuideScreen extends Screen {
    ...
    private static List<Line> overviewLines() {
        return List.of(
                ...
                h("승천 시련"), p("종말 단계에서 승천 중추를 완공한 뒤 다시 선택하면 4웨이브 반복 시련. 엘리트·변이와 바닐라 역할 조합을 상대로 신화 장비를 노립니다."),
    ...
    private static List<Line> unlockLines() {
        return List.of(
                ...
                h("승천 시련"), p("Stage 2 + 승천 중추 완공. 입장: 메아리32 · 자수정64 · 드래곤의 숨결8. 4웨이브, 웨이브당 60초, 완료 시 신화 III 장비 보장."),
    ...
    private static List<Line> controlLines() {
        return List.of(
                ...
                h("승천 시련"), p("열린 지형에서 시작. 보스바로 남은 적/시간 확인. 사망·64블록 이탈이 10초 지속되거나 제한시간 초과 시 실패하며 입장 재료는 반환되지 않음."),
