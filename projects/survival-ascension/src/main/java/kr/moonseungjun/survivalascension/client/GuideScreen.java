...
public final class GuideScreen extends Screen {
    ...
    private static List<Line> overviewLines() {
        return List.of(
                ...
                h("물류 통과 창고군"), p("산업 가공소 완공 후 기본 통을 물류 거점으로 등록합니다. 거점 주변 실제 통을 창고군으로 연결하며, 같은 차원에서 현재 로딩된 등록 창고는 플레이어와 거리가 멀어도 제작·건축·인프라·재련의 공용 재고로 사용됩니다. 단, 청크를 강제로 로드하지 않으므로 미로딩 창고는 건드리지 않습니다. 원정/방어전의 전초 현지 보급만은 해당 전초의 실제 재고를 요구합니다."),
