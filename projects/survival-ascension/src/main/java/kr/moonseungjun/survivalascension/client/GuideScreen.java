...
public final class GuideScreen extends Screen {
    ...
    private static List<Line> overviewLines() {
        return List.of(
                ...
                h("방어구 승천 옵션"), p("각인 방어구는 착용 중에만 작동합니다. 수호=상시 피해 감소, 불굴=체력 절반 이하 추가 감소, 숙련=전투 숙련 XP 증가, 완강=8 이상 큰 피해 추가 감소, 보호=공격 주체가 없는 피해 추가 감소입니다. 네 부위 합산 옵션 피해 감소는 최대35%, 방어구 숙련 XP는 최대32% 추가입니다."),
