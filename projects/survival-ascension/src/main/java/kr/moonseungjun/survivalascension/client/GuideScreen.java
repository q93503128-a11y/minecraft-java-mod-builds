...
public final class GuideScreen extends Screen {
    ...
    private static List<Line> overviewLines() {
        return List.of(
                ...
                h("전투"), p("피해 성장 + 근접 파급. 고성장 지역에서는 적이 전단장/돌격/추적/지원 역할의 전술 분대를 구성할 수 있음."),
    ...
    private static List<Line> unlockLines() {
        return List.of(
                ...
                p("건축 공방 완공 + 건축 Lv.90: 5×5×5 입체 채우기. 기존 재료 소비·보호 이벤트·틱 큐를 그대로 사용."),
    ...
    private static List<Line> controlLines() {
        return List.of(
                ...
                h("전술 분대"), p("평균 숙련 30+ 주변 자연 적이 3~6체 분대로 묶일 수 있음. 전단장을 먼저 쓰러뜨리면 8초간 분대가 후퇴하며 메아리 조각 보상."),
                h("질주 충격파"), p("전투 훈련장 완공 + 전투 Lv.90 상태에서 질주하며 직접 근접 공격. 준비되면 기존 파급 대신 360° 충격파 발동."),
