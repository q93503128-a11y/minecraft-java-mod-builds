...
public final class GuideScreen extends Screen {
    ...
    private static List<Line> overviewLines() {
        return List.of(
                ...
                h("승천 시련"), p("종말 단계에서 승천 중추를 완공한 뒤 다시 선택하면 4웨이브 반복 시련. 매 판 쇄도/추격/봉쇄 전술 교리 중 하나가 정해지고 웨이브 중반에 교리별 증원이 들어옵니다."),
                h("각성 신화 장비"), p("신화 III 장비는 M→장비→신화 각성에서 대량 자원을 소모해 기존 3 affix를 보존한 채 4번째 affix를 한 번 추가할 수 있습니다."),
    ...
    private static List<Line> unlockLines() {
        return List.of(
                ...
                h("승천 시련"), p("Stage 2 + 승천 중추 완공. 입장: 메아리32 · 자수정64 · 드래곤의 숨결8. 4웨이브, 웨이브당 60초, 교리별 중반 증원, 완료 시 신화 III 장비 보장."),
                h("시련 교리"), p("쇄도=근접 압박 · 추격=기동형 적 추적 · 봉쇄=원거리/제어. 같은 웨이브 수라도 실제 상대 조합과 증원이 달라집니다."),
                h("신화 각성"), p("신화 III 전용 1회 승격. 자수정256 · 다이아24 · 네더라이트 파편8 · 메아리64 · 드래곤의 숨결16 → 기존 3 affix 유지 + 4번째 affix."),
    ...
    private static List<Line> controlLines() {
        return List.of(
                ...
                h("M → 장비"), p("재련 / 신화 각성 / 분해 / 장비 정보. 각성 신화 재련은 4 affix 상태를 유지하지만 일반 신화보다 재련 비용이 큽니다."),
                h("M → 인프라"), p("채석장 / 관개 / 건축 공방 / 전투 훈련장 / 승천 중추 / 진행도."),
                h("승천 중추"), p("종말 단계에서만 건설 가능. 기동 Lv.90은 공중 돌진 2회, Lv.100은 3회. 완공 후 다시 선택하면 승천 시련."),
                h("승천 시련"), p("열린 지형에서 시작. 보스바에 현재 교리/남은 적/시간 표시. 웨이브 절반 부근에는 증원이 도착합니다. 사망·64블록 이탈이 10초 지속되거나 제한시간 초과 시 실패."),
