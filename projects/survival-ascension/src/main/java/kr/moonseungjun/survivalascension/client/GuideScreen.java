...
public final class GuideScreen extends Screen {
    ...
    private static List<Line> unlockLines() {
        return List.of(
                ...
                h("산업 / 전초"), p("Stage1 산업 가공소 → 4계통 생산 → 보급권 → 배럴 거점 → 물리 전초기지. 전초 승격은 보급권2+철32+금8+석탄32."),
                h("현장 복귀 계약"), p("활성 전초4블록 안에서 보급권1 선결제. 일반 사망96블록만 대상이며 사건/Apex/시련 사망은 계약을 소비하지 않습니다."),
                h("정점 / 승천 시련"), p("정점: Stage1 추적소+완수 원정권, 90초. 시련: Stage2 승천 중추, 4웨이브. 진행 중 원정 작전과 중첩 시작 불가."),
    ...
    private static List<Line> controlLines() {
        return List.of(
                ...
                h("원정 작전 시작"), p("완수한 원정권의 활성 전초4블록 안에서 망원경 아이콘 선택. 진행 중 다시 선택하면 현재 전진선/목표/남은 시간을 표시합니다."),
                h("원정 작전 귀환"), p("전진선과 두 현장 목표를 끝낸 뒤 출발한 바로 그 전초8블록 안으로 돌아옵니다. 전초 구조가 실제로 유지되어야 귀환 완료됩니다."),
                h("물류 / 전초"), p("배럴 거점은 일반32블록, 활성 전초는64블록까지 실제 재고를 대량 건축/관개에 공급합니다. 청크 강제로드 없음."),
