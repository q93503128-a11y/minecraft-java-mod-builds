...
class Region01BossFieldReadabilityOverlayTest {
    @Test
    void localAreaSamplesStayOnAuthoredRadius() {
        ...
        List<Region01BossFieldReadabilityOverlay.LocalSample> samples =
            Region01BossFieldReadabilityOverlay.localSamples(profile);
