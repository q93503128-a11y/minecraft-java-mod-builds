...
/**
 * Presentation-only Iron Golem used by Character Detail and the virtual battle stage.
 * Gameplay remains authored as minecraft:iron_golem; this entity owns no AI, drops, combat authority or save state.
 */
public final class IronGolemVisualEntity extends Monster implements PresentationPoseAware {
    private TurnboundPresentationPose presentationPose = TurnboundPresentationPose.NEUTRAL;

    public IronGolemVisualEntity(EntityType<? extends Monster> type, Level level) {
        super(type, level);
    }
