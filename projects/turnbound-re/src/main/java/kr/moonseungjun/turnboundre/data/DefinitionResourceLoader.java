...
public final class DefinitionResourceLoader implements ResourceManagerReloadListener {
    ...
    public void onResourceManagerReload(ResourceManager resourceManager) {
        ...
        TurnboundRe.LOGGER.info(
                "Loaded TURNBOUND definitions generation={} hash={} resources={} actions={} characters={} statuses={} encounters={} rewards={} progressions={} regions={}",
                ...
                installed.registry().progressions().size(), installed.registry().regions().size());
    }
