...
- Final JAR: `countrysidedays-0.1.0-alpha.1.jar`
- Existing-world compatibility: 신규 프로젝트이므로 기존 Countryside Days 월드와 호환을 약속하지 않는다. 이후 공개 알파부터 저장 키와 월드 호환 규칙을 고정한다.
