...
- Workflow run: 30622730291
- Source commit: 4e0b81d0d1ea512624d9c57b7de784dd1629c47e
...
```text
    location: class RuralGameplayHandler
  /home/runner/work/minecraft-java-mod-builds/minecraft-java-mod-builds/projects/countryside-days/src/main/java/kr/countrysidedays/world/CountrysideRegionManager.java:26: error: cannot find symbol
          return level.getChunkSource().getGenerator() instanceof FlatLevelSource;
                                                                  ^
    symbol:   class FlatLevelSource
    location: class CountrysideRegionManager
  /home/runner/work/minecraft-java-mod-builds/minecraft-java-mod-builds/projects/countryside-days/src/main/java/kr/countrysidedays/world/CountrysideWorldData.java:124: error: cannot find symbol
          return terrainChunks.contains(ChunkPos.asLong(chunkX, chunkZ));
                                                ^
    symbol:   method asLong(int,int)
    location: class ChunkPos
  /home/runner/work/minecraft-java-mod-builds/minecraft-java-mod-builds/projects/countryside-days/src/main/java/kr/countrysidedays/world/CountrysideWorldData.java:128: error: cannot find symbol
...
/home/runner/work/minecraft-java-mod-builds/minecraft-java-mod-builds/projects/countryside-days/src/main/java/kr/countrysidedays/gameplay/RuralGameplayHandler.java:15: error: cannot find symbol
import net.minecraft.world.level.GameRules;
                                ^
  symbol:   class GameRules
  location: package net.minecraft.world.level
/home/runner/work/minecraft-java-mod-builds/minecraft-java-mod-builds/projects/countryside-days/src/main/java/kr/countrysidedays/world/CountrysideRegionManager.java:9: error: cannot find symbol
import net.minecraft.world.level.levelgen.flat.FlatLevelSource;
                                              ^
  symbol:   class FlatLevelSource
  location: package net.minecraft.world.level.levelgen.flat
/home/runner/work/minecraft-java-mod-builds/minecraft-java-mod-builds/projects/countryside-days/src/main/java/kr/countrysidedays/gameplay/RuralGameplayHandler.java:144: error: cannot find symbol
        level.getGameRules().getRule(GameRules.RULE_KEEPINVENTORY).set(true, level.getServer());
                                     ^
  symbol:   variable GameRules
  location: class RuralGameplayHandler
/home/runner/work/minecraft-java-mod-builds/minecraft-java-mod-builds/projects/countryside-days/src/main/java/kr/countrysidedays/world/CountrysideRegionManager.java:26: error: cannot find symbol
        return level.getChunkSource().getGenerator() instanceof FlatLevelSource;
                                                                ^
