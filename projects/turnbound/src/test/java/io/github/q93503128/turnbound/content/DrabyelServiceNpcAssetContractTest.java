...
class DrabyelServiceNpcAssetContractTest {
 ...
 @Test void sharedNpcMotionHasIdleGreetingAndWork(){JsonObject a=load("assets/turnbound/geckolib/animations/entity/npc/drabyel_service.animation.json").getAsJsonObject("animations");for(String clip:Set.of("field.idle","field.walk","field.greet","field.work"))assertTrue(a.has(clip),clip);}
