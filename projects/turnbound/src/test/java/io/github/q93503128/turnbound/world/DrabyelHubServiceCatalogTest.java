...
class DrabyelHubServiceCatalogTest {
 ...
 @Test void surveyGateIsFailClosed(){assertTrue(DrabyelHubServiceCatalog.productionServices().isEmpty());for(var s:DrabyelHubServiceCatalog.hub().services())if(s.productionEnabled()){assertTrue(s.verifiedIn26_2(),s.locator());assertNotNull(s.runtimePosition(),s.locator());}}
