...
public final class AsterMarchRegionCatalog {
    ...
    private static final List<Anchor> FAST_TRAVEL = List.of(
            new Anchor(FT_RADIA, "라디아 계전소", new Vec3(0.0, 66.0, 20.0), 180.0F),
            new Anchor(FT_MEADOW, "남문 초원 계전소", new Vec3(190.0, 67.0, 230.0), 90.0F),
            new Anchor(FT_GLOAM, "그늘숲 계전소", new Vec3(-40.0, 70.0, -300.0), 180.0F),
            new Anchor(FT_AQUEDUCT, "붕괴 수로 계전소", new Vec3(-320.0, 67.0, 20.0), -90.0F),
            new Anchor(FT_QUARRY, "잿불 채석장 계전소", new Vec3(20.0, 70.0, 405.0), 0.0F),
            new Anchor(FT_RELAY, "구 중계소 계전소", new Vec3(365.0, 68.0, -305.0), 90.0F)
    );
    private static final List<Anchor> BOSSES = List.of(
            new Anchor(B01, "들이받는 왕 그라울", new Vec3(355.0, 68.0, 245.0), 90.0F),
            new Anchor(B02, "가시어미 베르나", new Vec3(-35.0, 72.0, -440.0), 180.0F),
            new Anchor(B03, "수문관리기 ORO-7", new Vec3(-430.0, 64.0, 35.0), -90.0F),
            new Anchor(B04, "재의 거상 콜바크", new Vec3(65.0, 63.0, 455.0), 0.0F),
            new Anchor(B05, "균열감시자 세라크", new Vec3(430.0, 66.0, -350.0), 90.0F)
    );
