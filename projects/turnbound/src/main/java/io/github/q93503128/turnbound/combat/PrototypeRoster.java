...
public final class PrototypeRoster {
    ...
    public static CombatantDefinition swordEnemy(String id, String name) {
        String b=id.toLowerCase()+"_basic";
        return new CombatantDefinition(id,name,new BattleStats(700,95,70,90),b,List.of(
                new SkillDefinition(b,"베기",TargetRule.ENEMY_SINGLE,0,List.of(SkillEffect.damage(1.00)))));
    }
