...
- [`earth-to-stars`](./earth-to-stars/) — EARTH TO STARS, SF 우주 개척 + 모듈식 함선 성장 + 협동 함선 운용
  - 상태: `P0 AUTOMATED TECHNICAL GATES COMPLETE / M1-C LAUNCH READINESS + ATMOSPHERE BACKEND VERIFIED / FUEL-OXYGEN DISK LIFECYCLE VERIFIED / LIVE FLIGHT NOT TESTED / LIVE MULTIPLAYER NOT TESTED / M1-D NEXT`
