...
import kr.moonseungjun.frontiersettlement.settlement.SettlementBuildingIntegrityService;
...
import kr.moonseungjun.frontiersettlement.settlement.SettlementExplorationService;
...
public final class FrontierSettlement {
    ...
    // Alpha.124 canonical/integrated validation trigger after paid military/territory investment.
    ...
    public FrontierSettlement(IEventBus modBus, ModContainer modContainer) {
        ...
        NeoForge.EVENT_BUS.addListener(SettlementBuildingIntegrityService::onServerTick);
        ...
        NeoForge.EVENT_BUS.addListener(SettlementCivilWorkService::onBreakBlock);
        NeoForge.EVENT_BUS.addListener(SettlementWaterfrontService::onBreakBlock);
        ...
        NeoForge.EVENT_BUS.addListener(SettlementMarketService::onBreakBlock);
        NeoForge.EVENT_BUS.addListener(SettlementWorkshopService::onBreakBlock);
