...
public final class BuildingPaletteScreen extends Screen {
    ...
    @Override protected void init(){
        ...
        addBuilding(BuildingType.LUMBER_CAMP,rightX,innerY+12,columnWidth); addBuilding(BuildingType.FARM,rightX,innerY+32,columnWidth); addBuilding(BuildingType.QUARRY,rightX,innerY+52,columnWidth); addBuilding(BuildingType.MINE,rightX,innerY+72,columnWidth); addBuilding(BuildingType.BLACKSMITH,rightX,innerY+92,columnWidth); addBuilding(BuildingType.WORKSHOP,rightX,innerY+112,columnWidth); addBuilding(BuildingType.CONSTRUCTION_OFFICE,rightX,innerY+132,columnWidth);
        int infraY=innerY+186;
