...
def main() -> None:
    ...
    # Four pinned Quaternius meshes are generated by the licensed-asset pipeline and must be
    # required inside the final JAR. Do not duplicate the generated binaries in src/main/resources.
    licensed = (ROOT / "tools/prepare_licensed_assets.py").read_text(encoding="utf-8")
    expected_assets = {
        "bastion.obj": "Warrior.obj",
        "striker.obj": "Rogue.obj",
        "ranger.obj": "Ranger.obj",
        "medic.obj": "Cleric.obj",
    }
    assert 'QUATERNIUS_RPG_MIRROR_COMMIT = "e50f41492f5cc35cffa7990ddb998e860881bd41"' in licensed
    for filename, source_name in expected_assets.items():
        assert f'"assets/villageguardians/models/mercenary/{filename}"' in licensed
        assert source_name in licensed
        ...
        assert not (ROOT / "src/main/resources/assets/villageguardians/models/mercenary" / filename).exists()
    ...
    print("[PASS] four pinned Quaternius mercenary OBJ meshes are generated once and required by JAR verification")
