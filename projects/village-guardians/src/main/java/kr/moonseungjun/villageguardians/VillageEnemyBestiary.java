...
public final class VillageEnemyBestiary {
    ...
    public static Dossier dossier(VillageEnemyArchetypeSystem.Archetype archetype) {
        ...
        return switch (archetype) {
            ...
            case CAVE_STALKER -> new Dossier(
                    "낮은 실루엣으로 측면을 파고드는 동굴거미 계열 침투병입니다.",
                    "근접하면 주기적으로 독과 둔화를 겹쳐 이탈을 어렵게 만듭니다.",
                    threat(archetype, "높음 · 독성 측면 침투"),
                    "성벽 모서리와 후방에서 붙기 전에 원거리 화력으로 먼저 끊으세요.");
            case BOGGED_ARCHER -> new Dossier(
                    "늪지 스켈레톤의 독화살을 사용하는 후방 저격병입니다.",
                    "일반 궁병보다 상태 이상 압박이 강해 오래 노출될수록 회복 부담이 커집니다.",
                    threat(archetype, "높음 · 독화살 지속 압박"),
                    "엄폐로 사선을 끊고 돌진·저격 기술로 후방을 빠르게 제거하세요.");
            case ZOGLIN_BREACHER -> new Dossier(
                    "조글린의 큰 체구와 돌진을 이용해 전선을 밀어내는 파성 야수입니다.",
                    "주기적인 근거리 충격으로 수비대를 둔화시키고 시설 피해도 1.58배입니다.",
                    threat(archetype, "매우 높음 · 야수 돌진/공성 1.58배"),
                    "성벽에 붙기 전에 둔화·집중 사격으로 이동 경로를 끊으세요.");
            case BREEZE_DISRUPTOR -> new Dossier(
                    "브리즈의 도약과 바람 공격으로 고정 진형을 흔드는 교란병입니다.",
                    "직선 화력 교환보다 위치 변경과 넉백으로 플레이어의 수비 각도를 무너뜨립니다.",
                    threat(archetype, "높음 · 도약/넉백 교란"),
                    "벽 끝과 낙하 지점을 피하고 원거리 추적 공격으로 이동 중에 압박하세요.");
            case MAGMA_BRUTE -> new Dossier(
                    "마그마 큐브의 낮고 넓은 몸체로 좁은 수비선을 압박하는 화염 근접병입니다.",
                    "주기적인 근거리 충격과 둔화로 발을 묶으며 시설에도 1.30배 피해를 줍니다.",
                    threat(archetype, "높음 · 근접 충격/공성 1.30배"),
                    "밀집해서 둘러싸지 말고 넓은 범위 공격과 원거리 화력으로 분산 처리하세요.");
            case NETHER_REAVER -> new Dossier(
                    "황금 도끼와 갑옷을 갖춘 좀비화 피글린 중장 돌격병입니다.",
                    "장시간 힘 강화를 받고 시설에도 1.18배 피해를 주는 정면 압박 병과입니다.",
                    threat(archetype, "높음 · 중장 근접/공성 1.18배"),
                    "방패 전열 뒤에 섞이기 전에 집중 공격으로 수를 줄이세요.");
            case SIEGE_BEAST -> new Dossier(
                    "갑주 약탈수가 올라탄 공성 거수입니다. 큰 체구로 성문과 밀집 수비대를 동시에 압박합니다.",
            ...
            case IRON_WARLORD -> new Dossier(
                    "철 골렘급 전쟁 갑주 위에 도끼 지휘관이 올라탄 중장갑 전쟁군주입니다.",
            ...
            case PLAGUE_ARCHON -> new Dossier(
                    "거대 거미를 타고 전선을 기어오르는 역병 마녀입니다. 독과 회복을 동시에 사용하며 방어탑을 선호합니다.",
            ...
            case DREAD_KNIGHT -> new Dossier(
                    "거대한 전쟁 멧돼지 위에 올라탄 검은 해골 기사입니다. 암흑과 흡혈로 근접 전선을 무너뜨립니다.",
