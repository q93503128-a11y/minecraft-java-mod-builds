...
- 용병은 코드에 경로만 남아 있던 Quaternius CC0 Warrior/Rogue/Ranger/Cleric OBJ 네 개를 핀 고정 원본에서 실제 리소스로 복구했다. 방벽 수호병/돌격 집행관/성루 명사수/전장 치유사의 외부 디자인 본체가 이제 JAR 필수 자산으로 검증된다.
