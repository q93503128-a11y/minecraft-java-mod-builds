...
- `STATUS_AND_R01_ENCOUNTERS.md` — element/status rules and concrete R01 ecology/elite/field-boss/first-dungeon combat kits. It expands the R01/combat work in `GAME_DESIGN.md` without overriding the master canon.
- `R01_VERTICAL_SLICE.md` — opening settlement, external player-motion bindings and first 55–75 minute playable R01 route. It expands the opening/R01 work in `GAME_DESIGN.md` without overriding the master canon.
- `RECOVERY_PRODUCTION_APPEARANCE.md` — recovery belt, potions, food, alchemy/cooking, light profession mastery and external-first armor/apparel/Wardrobe rules. It expands `GAME_DESIGN.md` §§5, 12, 15, 16 and 24 without overriding the master canon.
...
- `REGION_CROSS_AUDIT.md` — later R01–R12 cross-region anti-repetition, regional-identity, encounter/dungeon/evidence/service/resource and travel-density audit. Within the regional workstream it refines older package details where explicitly stated, including replacing R02's duplicated `2 of 3 clues` guardian-discovery pattern with continuous environmental disturbance/trail language; `GAME_DESIGN.md` still wins any conflict.
...
- `R06_IMPLEMENTATION_PACKAGE.md` — implementation-ready Mirewater Delta package: external wetland/open-world precedents, raised alchemist settlement, dry/boardwalk/shallow/deep traversal without swamp slowdown, wetland ecology and Hydra field boss, sunken flow-regulator dungeon, Act-II Regional Stewardship evidence, authored water-state controllers, regional aftermath/audio/multiplayer/performance gates.
- `R07_IMPLEMENTATION_PACKAGE.md` — implementation-ready Sunscar Desert package: external desert/open-world precedents, oasis/caravan culture, no heat/thirst chores, road/dune/badlands route choice, Desert Beetle/Armor of Desert/Ferox Deathworm directions, buried aquifer-fortress dungeon, central-resource-allocation Act-II evidence, regional aftermath/audio/multiplayer/performance gates.
- `R08_IMPLEMENTATION_PACKAGE.md` — implementation-ready Bloomveil high-tier magical-region package: Fae/open-world content precedents, sanctuary culture, restrained magical visual hierarchy, Hummingbird/Flutter/Knowledge Fairy ecology, ritual Titan Rabbit field boss, glass-root archive dungeon, Act-III evidence about valuable post-network magical emergence, regional aftermath/audio/multiplayer/performance gates.
- `R09_IMPLEMENTATION_PACKAGE.md` — implementation-ready Southstone Marches package: grounded trade-road culture, caravan fort/foundry economy, Elephant mount integration, heavy physical ecology/encounters, canyon-fortress dungeon, human-maintained infrastructure evidence and regional aftermath/performance contracts.
- `R10_IMPLEMENTATION_PACKAGE.md` — implementation-ready Cinderfall package: volcanic-route traversal without a heat-maintenance meter, forge-enclave economy, Scorch Golem/Basalt Wyvern/Inferno directions, caldera-foundry dungeon, partial-restoration benefit-and-cascade-risk story evidence, high-tier smithing loop and spectacle/performance gates.
- `R11_IMPLEMENTATION_PACKAGE.md` — implementation-ready Inner Sea package: Lv28 coast/Lv44 open-sea/Lv64 abyss layers, active maritime economy, Laviathan acquisition, custom fishing/aquatic ecology, deep-dive utility without a separate underwater progression tree, sea-fort and abyssal-temple content, Abyss Fang deep boss and underwater-combat technical gates.
- `R12_IMPLEMENTATION_PACKAGE.md` — implementation-ready Obsidian Rift package: sparse anomaly exploration, grounded paranormal/environmental-storytelling rules, Edge Refuge, optional altar-summoned Terradragon world boss, Sky Drake unlock, Central Anchor finale structure, Restore/Release/Partition ending handoff, postgame continuity and explicit final-guardian external-asset gate.
