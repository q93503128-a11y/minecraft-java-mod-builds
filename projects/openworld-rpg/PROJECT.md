...
- broad player-facing R01 world/UI implementation is still incomplete, but persistent server-owned save state now exists for combat Lv/EXP, per-root Class Rank/XP, Attributes, equipped combat loadout, personal R01 progression, Gold, and reconnect-safe pending/completed reward transactions
