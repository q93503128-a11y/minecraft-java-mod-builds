...
PLAYER DEFENSIVE EQUIPMENT PUBLISHER: IMPLEMENTED + UNIT/BUILD/STARTUP VERIFIED — per-slot-rounded armor DEF/MR + shield-family GuardRating + Defense/MR/Guard Strength affix aggregation; weapon guard rating intentionally UNBOUND; run 35688379194
PLAYER INCOMING DAMAGE BRIDGE: IMPLEMENTED + BUILD/STARTUP VERIFIED — explicit normalized project hits resolve Defense/MR/dodge/guard/perfect-guard/Stamina before HP application; project-owned external-actor donor HP damage to players FAIL-CLOSED; Earthloong Phase-1 Claw/Tail/Quarry canonical physical impact data + authority IMPLEMENTED; spatial/animation hit-event adapter NOT IMPLEMENTED
...
BUILD VERIFIED: YES — run 35688379194
JAR PRODUCED: YES
