...
|---|---|---|---|---|
| R01 | Earthloong dungeon boss | Threateningly Mobs Continued — exact Fabric 26.2 target `1.1.1+fabric.26.2`, Version ID `Bdd8lkUM` | `DEPENDENCY_VALIDATE` | artifact/animation surface is byte-inspected and Phase-1 technical bindings exist; Tail Scythe plus Forked Heaven/Earthline Surge signature presentation/VFX still require accepted player-facing binding and real Minecraft hitbox/readability review |
