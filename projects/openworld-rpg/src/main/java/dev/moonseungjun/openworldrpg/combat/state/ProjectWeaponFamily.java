...
public enum ProjectWeaponFamily {
    DAGGER(0.88, 0.55, 0.15, 0.85, 0.0, 0.0),
    DUAL_BLADES(1.03, 0.65, 0.25, 0.75, 0.0, 0.0),
    SWORD(0.95, 1.00, 0.50, 0.50, 0.0, 0.0),
    GREATSWORD(1.10, 1.60, 0.80, 0.20, 0.0, 0.0),
    SPEAR(1.03, 1.10, 0.40, 0.60, 0.0, 0.0),
    AXE(0.97, 1.35, 0.75, 0.25, 0.0, 0.0),
    HAMMER_MACE(1.10, 1.80, 0.90, 0.10, 0.0, 0.0),
    BOW(1.02, 0.80, 0.10, 0.90, 0.0, 0.0),
    CROSSBOW(1.07, 1.10, 0.25, 0.75, 0.0, 0.0),
    BLACK_POWDER_PISTOL(0.95, 0.90, 0.20, 0.80, 0.0, 0.0),
    MUSKET_HAND_CANNON(1.10, 1.25, 0.35, 0.65, 0.0, 0.0),
    STAFF(1.00, 0.85, 0.0, 0.0, 0.85, 0.15),
    WAND(0.82, 0.50, 0.0, 0.0, 0.75, 0.25);
